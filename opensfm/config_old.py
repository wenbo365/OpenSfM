...
class OpenSfMConfig:
    ...
    five_point_algo_threshold: float = 0.0001
    ...
    triangulation_refinement_iterations: int = 1000
    ...
    retriangulation_ratio: float = 1.1
